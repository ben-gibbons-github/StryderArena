...
namespace Orb
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
       ...
       // LocalPlayer view;
        ...
        /// </summary>
        public void DrawParticles(LocalPlayer player)
        {
           // particleEffect.Parameters["DepthTexture"].SetValue(DepthTexture);
            //particleEffect.Parameters["CameraPos"].SetValue(new Vector4( player.CameraPos,0));
            ...
            if (firstActiveParticle != firstFreeParticle)
            {
                ...
                particleEffect.Parameters["viewSize"].SetValue  (new Vector2( device.Viewport.Width*2, device.Viewport.Height*2));
        ...
        /// </summary>
        public void SetCamera(Matrix view, Matrix projection,Game1 Game,int Playernumber)
        {
            if (firstActiveParticle != firstFreeParticle)
            {
                Ready = true;
