...
//shadows
 ...
 if(distance(DiffuseLightPosition,input.WorldPos)/(Distance)<((ShadowBase.x+ShadowBase.y+ShadowBase.z)/3))//+0.01)
 {
...
//texcoord
	...
	float2 TexCoord=float2 ((input.WorldPos.x/400+100000)-floor(input.WorldPos.x/400+100000),(input.WorldPos.z/400+100000)-floor(input.WorldPos.z/400+100000));
