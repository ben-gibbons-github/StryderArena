...
//diffuse
	...
	if(BestDistance<DistMult)
	{
	BestDirection=normalize(DiffuseLightPosition[i]-worldPosition);
	BestDistance=DistMult;
	}
...
//best direction
    output.BestDirection=BestDirection;
